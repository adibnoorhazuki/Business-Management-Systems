        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="logo-container">
                    <img src="{{ asset('assets/img/bms.png') }}" width="100px" height="90" alt="">
                </div>
                </div>
                <div class="card-body ">
                <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="email" value="{{ old('email', 'admin@bms.com') }}" required autofocus>
                </div>
                @if ($errors->has('email'))
                ...
                <button  type = "submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('Log In') }}</button>
                <div class="pull-left">
                    <h6>
